...
#[Route(path: '/admin/blog/etiquettes', name: 'blog_post_tag_')]
...
class PostTagController extends AbstractController
{
    ...
    public function index(PostTagRepository $postTagRepository, PaginatorInterface $paginator, Request $request): Response
    {
        ...
        return $this->render('@AkyosCms/crud/index.html.twig', ['els' => $els, 'title' => 'Étiquettes d\'article', 'entity' => 'PostTag', 'view' => 'tag', 'route' => 'blog_post_tag', 'fields' => ['ID' => 'Id', 'Title' => 'Title', 'Description' => 'Content',],]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('@AkyosCms/crud/new.html.twig', ['el' => $postTag, 'title' => 'Étiquette d\'article', 'entity' => 'PostTag', 'route' => 'blog_post_tag', 'form' => $form->createView(),]);
    }
    ...
    public function edit(Request $request, PostTag $postTag, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('@AkyosCms/crud/edit.html.twig', ['el' => $postTag, 'title' => 'Étiquette d\'article', 'entity' => 'PostTag', 'route' => 'blog_post_tag', 'view' => 'archive', 'form' => $form->createView(),]);
    }
